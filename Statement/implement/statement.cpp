...
namespace Oblivia{
	std::ostream&operator<<(std::ostream&os,const StatementType&a){
		switch(a){
			...
			case StatementType::IFn:os<<"IFn";break;
			...
			case StatementType::Return:os<<"Return";break;
		}
		return os;
	}
	...
	StatementType getStateType(const Tokens&a){
		...
		else if(a[0].str=="ifn")return StatementType::IFn;
		...
		else if(a[0].str=="return")return StatementType::Return;
	...
	Situation buildStatement(std::unique_ptr<Statement>&r,size_t l,const Tokens&t){
		...
		switch(type){
			...
			case StatementType::IFn:r=std::make_unique<IFn>(l,t);break;
			...
			case StatementType::Return:r=std::make_unique<Return>(l,t);break;
